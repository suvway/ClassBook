		...
		<div class="list-group">
			<div class="list-group-item board-title">
				<div class="board-title">
					<span class="board-category">[CATEGORY]</span><a href="#">
						${info.subject } </a> 
				</div>
				<div class="board-meta"
					style="font-weight: 400; font-size: 1.2rem; color: #404040">
					<p>
						<i class="glyphicon glyphicon-user"></i> ${info.name }
			...
			<div class="list-group-item">
				<span class="board-contents"><img src="/web/upload/${info.fileName}" height="400"> ${info.contents } </span>
				<p style="text-align: center; margin-top: 30px">
					...
					<a href="/web/downloadAction.do?fileName=${info.fileName }">
					<button class="btn btn-warning">
						${info.fileName }</i>다운로드
					</button>
					</a>
				</p>
			</div>
			<div class="bottom" style="margin: 10px;margin-top: 20px; text-align: right">
				<a href="/web/bootList.do" class="btn btn-default btn-xs pull-left">목록으로</a> 
				<a href="/web/bootBoard/infoSelect.do?no=${info.no }&job=modify" class="btn btn-default btn-xs">수정</a> 
